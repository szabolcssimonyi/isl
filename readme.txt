...
2. Nyisd meg egy szövegszerkesztővel a [saját mappa]/isl/config/main.php állományt és állítsd meg a mysql szerver adatait
2. Állítsd a html szerver munkakönyvtárát a [saját mappa]/isl/migrations könyvtárra és command prompt-ból futtasd a migrations.php file-t:
    ...
    a migráció folymatát láthatod a command window-ban
